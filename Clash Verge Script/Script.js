...
function overwriteProxyGroups (params) {
  ...
  const groups = [
      ...
      },
      {
          ...
          proxies: ["HK - 手动选择", "JP - 手动选择", "KR - 手动选择", "SG - 手动选择", "US - 手动选择", "UK - 手动选择", "FR - 手动选择", "DE - 手动选择", "TW - 手动选择", "其它 - 手动选择"],
      },
      {
          name: "自动选择",
          type: "select",
...
function overwriteRules (params) {
  ...
  const customRules = [
      ...
      "RULE-SET,direct_my,DIRECT",
      "RULE-SET,proxies_my,🎯 节点选择",
  ];
  ...
  const ruleProviders = {
      ...
      direct_my: {
        type: "http",
        behavior: "classical",
        url: "https://raw.githubusercontent.com/FFTU/ClashCustomRule/refs/heads/main/Clash%20Verge%20Script/direct_my.txt",
        path: "./rule_set/sukkaw_ruleset/direct_my.txt",
        interval: 43200,
        format: "text",
        proxy: "🎯 节点选择"
      },
      ...
      proxies_my: {
        type: "http",
        behavior: "classical",
        url: "https://raw.githubusercontent.com/FFTU/ClashCustomRule/refs/heads/main/Clash%20Verge%20Script/proxies_my.txt",
        path: "./rule_set/sukkaw_ruleset/proxies_my.txt",
        interval: 43200,
        format: "text",
        proxy: "🎯 节点选择"
      },
