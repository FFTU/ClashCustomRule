...
function overwriteProxyGroups(params) {
    ...
    const groups = [
        ...
        },
        {
            ...
            proxies: ["HK - 手动选择", "JP - 手动选择", "KR - 手动选择", "SG - 手动选择", "US - 手动选择", "UK - 手动选择", "DE - 手动选择", "TW - 手动选择"],
        },
        {
            name: "自动选择",
            type: "select",
        ...
        },
        {
            name: "✈️ 电报信息",
            type: "select",
            proxies: ["🎯 节点选择", "HK - 自动选择", "JP - 自动选择", "KR - 自动选择", "SG - 自动选择", "US - 自动选择", "UK - 自动选择", "", "DE - 自动选择", "TW - 自动选择", "其它 - 手动选择"],
            // "include-all": true,
        ...
        },
        {
            name: "🤖 AIGC",
            type: "select",
            proxies: ["US - 自动选择", "🎯 节点选择", "HK - 自动选择", "JP - 自动选择", "KR - 自动选择", "SG - 自动选择", "UK - 自动选择", "", "DE - 自动选择", "TW - 自动选择", "其它 - 手动选择"],
            // "include-all": true,
        ...
        },
        {
            name: "🍎 苹果服务",
            type: "select",
            proxies: ["DIRECT", "🎯 节点选择", "HK - 自动选择", "JP - 自动选择", "KR - 自动选择", "SG - 自动选择", "US - 自动选择", "UK - 自动选择", "", "DE - 自动选择", "TW - 自动选择", "其它 - 手动选择"],
            // "include-all": true,
...
function overwriteRules(params) {
    ...
    const nonipRules = [
        "RULE-SET,private_tracker,DIRECT",
    ...
    const baseRuleProviders = {
        ...
        china_ip: {
         ...
         private_tracker: {
            ...
            path: "./rule_set/sukkaw_ruleset/private_tracker.txt",
            interval: 43200,
            format: "text",
            proxy: "🎯 节点选择"
        }
